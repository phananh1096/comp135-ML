...
if __name__ == '__main__':
    ...
    x_NF = np.loadtxt('data_digits_8_vs_9_noisy/x_train.csv', delimiter=',', skiprows=1)
    y_N = np.loadtxt('data_digits_8_vs_9_noisy/y_train.csv', delimiter=',', skiprows=1)
    
    lr = LogisticRegressionGradientDescent(
        alpha=100, step_size=0.1, init_w_recipe='zeros')
